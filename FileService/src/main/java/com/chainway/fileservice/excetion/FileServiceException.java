package com.chainway.fileservice.excetion;
...
public class FileServiceException extends Exception {
	...
	public FileServiceException(int code,String msg,Object data){
		super();
		build(code, msg, data);
	}
	
	public FileServiceException(int code,String msg){
		super();
		build(code, msg, null);
	}
	
	public FileServiceException(Exception e,int code,String msg,Object data){
		super();
		String _msg=msg;
	...
	public FileServiceException(Exception e,int code,String msg){
		super();
		String _msg=msg;
		if(StringUtils.isEmpty(_msg)){
			_msg=e.getMessage();
