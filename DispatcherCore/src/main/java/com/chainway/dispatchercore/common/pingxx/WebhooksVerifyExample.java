...
public class WebhooksVerifyExample {
	...
	public static String getStringFromFile(String filePath) throws Exception {
		...
		InputStreamReader inReader = new InputStreamReader(
				new ClassPathResource("properties/pingpp_public_key.pem").getInputStream(), "UTF-8");
	...
	public static String getPingPublicKeyString() throws Exception {
		// FileInputStream in = new FileInputStream(filePath);
		InputStreamReader inReader = new InputStreamReader(
				new ClassPathResource("properties/pingpp_public_key.pem").getInputStream(), "UTF-8");
		BufferedReader bf = new BufferedReader(inReader);
	...
	public static PublicKey getPubKey() throws Exception {
		String pubKeyString = getPingPublicKeyString();
