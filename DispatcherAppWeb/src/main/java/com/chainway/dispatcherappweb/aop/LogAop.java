...
public class LogAop implements Ordered{
	...
	@AfterReturning(value="@annotation(com.chainway.dispatcherappweb.annotation.Log)", returning = "returnVal")
    public void afterReturin(Object returnVal){
		log.debug("------------------------正常结束---------------------------");
		log(0);
    }
	
	@AfterThrowing(value="@annotation(com.chainway.dispatcherappweb.annotation.Log)", throwing = "e")
